...
\ Code from 3/18 - Forth: Variables & Allocation


cr cr
." This file contains sample code from March 18, 2022," cr
...
: printrev  ( -- )
  ...
  alloc-fail? if                              \ Error checking!
    ...
    cr cr
    buf-addr free { free-fail? }              \ Deallocate (ignore errs)
  endif
;
