...
function test_idkey(t)
    ...
    checkLex(t, "abc cr_3", {"abc",IDx,"cr_3",IDx},
    ...
    checkLex(t, "read", {"read",KEYx}, "keyword: read")
    ...
    checkLex(t, "nott", {"nott",IDx}, "keyword+letter")
    checkLex(t, "print2", {"print2",IDx}, "keyword+digit")
    checkLex(t, "elsE", {"elsE",IDx}, "keyword -> 1 letter UC")
    checkLex(t, "AND", {"AND",IDx}, "keyword -> all UC")
    ...
    checkLex(t, "_print",{"_print",IDx}, "_ + keyword")
    checkLex(t, "begin",{"begin",IDx}, "former keyword: begin")
    checkLex(t, "def",{"def",IDx}, "former keyword: def")
    checkLex(t, "dq", {"dq",IDx}, "former keyword: dq")
    checkLex(t, "elseif",{"elseif",IDx}, "former keyword: elseif")
    checkLex(t, "end",{"end",IDx}, "former keyword: end")
    checkLex(t, "for", {"for",IDx}, "former keyword: for")
    checkLex(t, "input",{"input",IDx}, "former keyword: input")
    checkLex(t, "readnum",{"readnum",IDx}, "former keyword: readnum")
    checkLex(t, "write",{"write",IDx}, "former keyword: write")
...
function test_strlit(t)
    ...
    checkLex(t, "'abc cr'", {"'abc cr'",STRLITx},
...
function test_program(t)
    ...
    checkLex(t, "#!./tenrec.lua\n"..
                "print(\"Type a number: \");\n"..
                "n = read();\n"..
                "print('You entered: ', n, cr);",
            {"print",KEYx,"(",PUNCTx,"\"Type a number: \"",STRLITx,
             ")",PUNCTx,";",PUNCTx,"n",IDx,"=",OPx,"read",KEYx,
             "(",PUNCTx,")",PUNCTx,";",PUNCTx,"print",KEYx,"(",PUNCTx,
    ...
    checkLex(t, "a_1[0]=1;"..
                "a_1[a_1[0]]=a_1[0]+2;"..
                "_b2b=a_1[0]+3;"..
                "if(_b2b==6){print(\"good\",cr);}"..
                "elif(_b2b>6){print(\"too high\",cr);}"..
    ...
    checkLex(t,
        ...
        "}\n",
             ...
             "{",PUNCTx,
              ...
              "i",IDx,"=",OPx,"i",IDx,"+",OPx,"1",NUMLITx,";",PUNCTx,
              "}",PUNCTx,
              "return",KEYx,"currfib",IDx,";",PUNCTx,
              "}",PUNCTx,
              "how_many_to_print",IDx,"=",OPx,"20",NUMLITx,";",PUNCTx,
              "print",KEYx,"(",PUNCTx,"\"Fibonacci Numbers\"", STRLITx,
              ...
              "j",IDx,"=",OPx,"j",IDx,"+",OPx,"1",NUMLITx,";",PUNCTx,
              "}",PUNCTx},
              "Program from slides")
